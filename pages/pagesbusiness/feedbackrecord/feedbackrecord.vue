<template>
	<view>
		<view class="top">
			<uni-nav-bar left-icon="left" left-text="返回" title="反馈记录"></uni-nav-bar>
			<view class="buttom">
			...
			<view class="center">
				...
				<view class="centent">
					<view class="centent_top">
						< img src="../../../static/image/baoxiu1.png" alt="" srcset="" /> < img src="../../../static/image/baoxiu2.png" alt="" srcset="" /> < img
						src="../../../static/image/baoxiu1.png" alt="" srcset="" />
					</view>
