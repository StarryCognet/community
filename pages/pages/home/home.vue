<template>
  <view class="page-container">
    <uni-nav-bar leftWidth="110rpx" rightWidth="110rpx" :border="false" style="position: relative; z-index: 2" color="#fff" background-color="transparent" title="智慧社区"></uni-nav-bar>
